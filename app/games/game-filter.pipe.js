...
var GameFilterPipe = (function () {
    ...
    GameFilterPipe.prototype.transform = function (value, filterBy) {
        filterBy = filterBy ? filterBy.toLocaleLowerCase() : null;
        return filterBy ? value.filter(function (game) {
            return game.title.toLocaleLowerCase().indexOf(filterBy) !== -1;
        }) : value;
    };
